	...
	return (
		<Box p={4}>
			...
			<VStack>
				...
				<Field.Root required mb={4}>
					<Field.Label>
						所要時間(参考) <Field.RequiredIndicator />
					</Field.Label>
				...
				{/* 投稿・下書き・削除 */}
				<VStack>
					<Button colorPalette="green" minW="20vh" mb={3}>
						投稿
					</Button>
					<Button
						colorPalette="green"
					...
					<Button colorPalette="red" minW="20vh" mb={3}>
						削除
					</Button>
				</VStack>
			</VStack>
	...
	return (
		<Box p={4}>
			...
			<Flex gap="4" justify="space-between" mb={6}>
				...
				<Button colorPalette="red" minW="20vh">
					削除
				</Button>
			</Flex>
